				...
				<div id="content-2">
					...
					<div class="reservation">
						...
						<div class="reservationBtn">
							...
							<input type="button" id="reviewBtn" onclick="winOpen()"
								class="resBtn" style="background-color: #0E76B3; color: white"
								value="리뷰작성">
						</div>
					</div>
					...
					<script>
				        function winOpen(){
				        	 window.open("/views/member/reviewWriteWindow.jsp?coId=<%=c.getCoId()%>&contractNo=<%=c.getContractNo()%>
						",
											"_blank",
